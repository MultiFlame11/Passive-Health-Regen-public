...
public final class RegenHudRenderer {
    ...
    public void onAddLayers(AddGuiOverlayLayersEvent event) {
        event.getLayeredDraw().addAbove(ForgeLayeredDraw.VANILLA_ROOT, HUD_LAYER, ForgeLayeredDraw.HOTBAR,
            (guiGraphics, deltaTracker) -> render(guiGraphics, deltaTracker.getGameTimeDeltaTicks()));
    }

    private void render(GuiGraphics guiGraphics, float tickDelta) {
