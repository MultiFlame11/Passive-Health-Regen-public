...
public class PassiveRegenConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> BLOCKED_EFFECTS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> DIMENSION_BLACKLIST;
