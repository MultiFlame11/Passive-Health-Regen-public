...
public final class PassiveRegenConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue HUNGER_DRAIN_ENABLED;
    public static final ForgeConfigSpec.DoubleValue HUNGER_DRAIN_SPEED_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue HUNGER_DRAIN_COST_PER_HP;
    public static final ForgeConfigSpec.DoubleValue HUNGER_DRAIN_IDLE_DRAIN_PER_TICK;
    public static final ForgeConfigSpec.DoubleValue HUNGER_DRAIN_MIN_FLOOR;
    ...
    static {
        ...
        DISABLE_NATURAL_REGEN = builder.comment("If true, vanilla natural regeneration is disabled with the naturalRegeneration gamerule.").define("disableNaturalRegen", false);
        ...
        FREEZING_PENALTY_ENABLED = builder.define("freezingPenaltyEnabled", false);
    ...
    public static double combineBonusMultipliers(List<Double> multipliers) {
        ...
        switch (BONUS_STACKING_MODE.get()) {
            case ADDITIVE:
                double additiveResult = 1.0D;
                for (double multiplier : multipliers) {
                    additiveResult += multiplier - 1.0D;
                }
            ...
            default:
                ...
                for (double multiplier : multipliers) {
                    multiplicativeResult *= multiplier;
                }
