...
public final class RegenHudPacket {
    ...
    public static void send(ServerPlayerEntity player, long outOfCombatTicks, int damageCooldownTicks, boolean regenActive, boolean hungerBlocked, boolean justHealed, float currentHealth, float maxHealth, int maxRegenHealthPercent, boolean nearCampfire, boolean saturationBonus, boolean poisoned, boolean withered) {
    ...
    public static void encode(RegenHudPacket packet, PacketBuffer buf) {
    ...
    public static RegenHudPacket decode(PacketBuffer buf) {
