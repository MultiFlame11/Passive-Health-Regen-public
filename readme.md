...
Current release: **1.3.3**. See [CHANGELOG-1.3.3.md](CHANGELOG-1.3.3.md) for the latest release notes, [CHANGELOG-1.3.2.md](CHANGELOG-1.3.2.md) for the previous patch, [CHANGELOG-1.3.0.md](CHANGELOG-1.3.0.md) for the big parity release, and [MODDING.md](MODDING.md) for resource pack / addon author info.
